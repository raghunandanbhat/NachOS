...
/*
* System call SysExec()
* @param: *filename - pointer to address space of userprogram to be executed by Exec()
*	
*/
void SysExec(AddrSpace *filename){
	//Execute the user program loaded in the address space
	filename->Execute();
	return;
}
